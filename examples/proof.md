...
- $\gcd(p,q) \geq 2$ Contradiction — Two even numbers must have a common factor 2 ✓
...
- The rational root theorem requires $p \mid \text{constant term}$, $q \mid \text{leading term coefficient}$ ✓
